	...
	<div data-options="region:'west'" split="true" border="false" title="首页" style="width:200px" id="sidebar">
		...
		<div class="accordion" style="display=block">
			<div title="常用操作">
				<dl style="display:block">
					<dd><a href="{:U('Nav/index')}" target="in">网站栏目管理</a></dd>
					<dd><a href="{:U('Article/index')}" target="in">文档管理</a></dd>
					<dd><a href="#">网站公告</a></dd>
		...
		<div class="accordion" style="display:none;">
				<dl>
					...
					<dd><a href="{:U('Manage/manageList')}" target="in">管理员列表</a></dd>
					<dd><a href="{:U('Level/levelList')}" target="in">等级列表</a></dd>
		...
		<div class="accordion" style="display:none;">
				<dl>
					<dd><a href="{:U('Model/index')}" target="in">模板列表</a></dd>
					<dd><a href="#" target="in">待开发</a></dd>
					<dd><a href="#" target="in">待开发</a></dd>
					<dd><a href="#" target="in">待开发</a></dd>
				</dl>
